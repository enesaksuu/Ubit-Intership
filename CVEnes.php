...
$cv["name"]="Enes";
$cv["surname"]="Aksu";
$cv["date of Birth"]="02.05.2002";
$cv["Address"]="Demirkapı Mahallesi 1640.Sokak No:18 Daire:23 Bağcılar/İstanbul";
$cv["Marital Status"]="Single";
$cv["E-Mail"]="enesgs_75@hotmail.com";
$cv["Mobile Phone"]="0532 052 3378";
...
$cv["Hobbies"]="Driving Car, Swimming, Software and Read a Book "
    ...
    <body>
      <header>
        <div class="col-md-12" style="text-align: center; margin-top: 2em;">
            ...
            <img src="b0feb1cf-c839-4b4b-9751-473a4b1ef321.jpg" width="200px" height="180px">
        </div>
      </header>
      <div class="container">
